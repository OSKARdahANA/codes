...
client.on("message", msg => { //elso7ab yla server
  if(msg.author.bot) return;
...
if(!message.channel.guild) return message.reply(' ');
  ...
  let rank = message.guild.member(message.author).roles.find('name', '• Selso7ab yla » Support');
...
client.login('NTYzNDMyOTk4NDY1MzA2NjI2.XLX6JA.PjnbjodVAaY276nN6--ScNVg6b0');
